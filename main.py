            ...
            return html.Div(
                [
                    ...
                    render_page_layout(
                        ...
                        footer=render_page_footer(page_number=2),
                    ),
                    # Страница 1.1
                    # 2 страница
                    render_page_layout(
                        ...
                        footer=render_page_footer(page_number=3),
                    ),
                    # Page 4
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                        ...
                        footer=render_page_footer(page_number=4),
                    ),
                    # Page 5
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                        ...
                        footer=render_page_footer(page_number=5),
                    ),
                    # Page 6
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                        ...
                        footer=render_page_footer(page_number=6),
                    ),
                    # Page 7
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                    ...
                    render_page_layout(
                        ...
                        content=[
                            ...
                            html.Div(
                                [
                                    render_ratios_header("6", "Воспаление, стресс и нейромедиаторный баланс"),
                                    render_ratios_row(
                        ...
                        footer=render_page_footer(page_number=9),
                    ),
                    # Page 10
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                        content=[
                            ...
                            html.Div(
                                [
                                    render_ratios_header("7", "Метилирование, обмен холина и метионина"),
                                    render_ratios_row(
                                    ...
                                    render_ratios_header("8", "Состояние сосудистой системы и эндотелиальной функции"),
                                    render_ratios_row(
                        ...
                        footer=render_page_footer(page_number=10),
                    ),
                    # Page 11
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                            ...
                            html.Div(
                                [
                                    render_ratios_header(
                                        "8", " Энергетический обмен, цикл Кребса и баланс аминокислот"
                                    ),
                                    render_ratios_row(
                        ...
                        footer=render_page_footer(page_number=11),
                    ),
                    # Page 12
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
                        content=[
                            ...
                            html.Div(
                                [
                                    render_ratios_header("10", "Здоровье митохондрий и β-окисление жирных кислот"),
                                    render_ratios_row(
                        ...
                        footer=render_page_footer(page_number=12),
                    ),
                    # Page 13
                    render_page_layout(
                        header=render_page_header(date=date, name=name),
